...
Image stamping has been improved too: it’s now possible to write details on your images coming from the layer and edited feature the images will be attached to. This is sure to please many of our users as it was requested more than once across our community discourse and ideas platform.
...
On the feature form side,the value relation editor widget is now doing accent-less searches allowing for faster data entry. The relation editor widgets respect the configured sorting order defined during project set up. And finally, the gallery editor’s chosen mode – thumbnail vs. list - will be remembered.
